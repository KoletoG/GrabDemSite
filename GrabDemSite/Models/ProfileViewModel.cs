...
namespace GrabDemSite.Models
{
    public class ProfileViewModel
    {
        ...
        public List<DepositDataModel> DepositOrders { get; private init; }
        public List<WithdrawDataModel> WithdrawOrders { get; private init; }
        public ProfileViewModel(List<UserDataModel> lv1, List<UserDataModel> lv2, List<UserDataModel> lv3, decimal wholeBal, List<DepositDataModel> deposits, List<WithdrawDataModel> withdraws, UserDataModel user)
        {
            userslv1 = lv1;
            userslv2 = lv2;
            userslv3 = lv3;
